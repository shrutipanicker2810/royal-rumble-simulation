...
class WrestlingAgent:
    ...
    def choose_action(self, observation):
        ...
        if self.wrestler.stamina <= 10:
            return 3  # No-op if out of stamina
        ...
        if distance > 1.5:  # Far from opponent - recover stamina
            action_probs[3] = 0.8  # No probability for no-op
            ...
            action_probs[2] = 0.33   # Signature move favors strength
            action_probs[3] = 0   # Small chance to do nothing
